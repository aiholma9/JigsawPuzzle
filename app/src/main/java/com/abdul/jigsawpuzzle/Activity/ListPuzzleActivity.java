...
public class ListPuzzleActivity extends AppCompatActivity {
    ...
    private void loadBackgroundList() {
        query = FirebaseDatabase.getInstance().getReference(Common.PUZZLES)
            ...
            protected void onBindViewHolder(@NonNull final ListPuzzleViewHolder holder, int position, @NonNull final PuzzleItem model) {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position) {
                        Intent intent = new Intent(ListPuzzleActivity.this, CreateActivity.class);
